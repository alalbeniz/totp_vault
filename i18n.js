(() => {
  ...
  const textKeys = new Map([
    ...
    ["Procesado localmente · URL: permiso solo para ese dominio.","qrSecurity"],["Revisar importación","qrMigrationTitle"],["UNA LLAVE MÁS","addEyebrow"],["Añadir TOTP","addTotp"],
    ...
    ["Cambiar contraseña maestra","changeMasterPassword"],["Apoya TOTP Vault","supportTitle"],["Si TOTP Vault te resulta útil, puedes apoyar su desarrollo.","supportText"],["Invítame a una cerveza","supportButton"],["Contraseña actual","currentPassword"],["Nueva contraseña","newPassword"],
